...
<p>We're here to help you succeed online — response within 24 hours</p></div>
<section class="sec">
  <div class="wrap">
    <div class="cg">
      <div class="ci aos">
        ...
        <div class="cd"><i class="fas fa-clock"></i><span>Mon–Sat: 9 AM – 7 PM IST</span></div>
      ...
      <div class="cf aos">
        <form id="cf" novalidate>
          ...
          <div class="fg"><label>Message *</label>
            <textarea name="message" rows="5" placeholder="Describe your project or requirements…" required></textarea>
          </div>
